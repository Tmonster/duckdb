...
const char* EnumUtil::ToChars<AddType>(AddType value) {
	...
	case AddType::COPY:
		return "COPY";
	default:
		throw NotImplementedException(StringUtil::Format("Enum value: '%d' not implemented in ToChars<AddType>", value));
	}
}
...
AddType EnumUtil::FromString<AddType>(const char *value) {
	if (StringUtil::Equals(value, "APPEND")) {
		return AddType::APPEND;
	}
	if (StringUtil::Equals(value, "COPY")) {
		return AddType::COPY;
	}
	throw NotImplementedException(StringUtil::Format("Enum value: '%s' not implemented in FromString<AddType>", value));
}

...
//	if (plan->children.size() > 0 && plan->children[0]->type == LogicalOperatorType::LOGICAL_GET) {
//		auto &get = (LogicalGet&)*plan->children[0];
//		auto catalogTable = get.GetTable();
//		std::cout << catalogTable->name << " has internal catalog id " << catalogTable->oid << std::endl;
//	}
